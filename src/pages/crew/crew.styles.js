...
export const StyledCrewInfoContainer = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
  ...
  margin-bottom: 50px;
`;
export const StyledCrewMemberTitle = styled.span`
  font-size: ${TYPOGRAPHY.fontSizeTextPreset8};
  ...
  margin: 0;
`;
export const StyledCrewMemberName = styled.span`
  ...
  margin: 0;
`;
export const StyledCrewMemberDescription = styled.p`
  font-size: ${TYPOGRAPHY.fontSizeTextPreset8};
